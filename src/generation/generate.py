...
if __name__ == "__main__":
    ...
    for category in data:
        ...
        if category_type in ["description_human"] or category_type == "fully_fictional" or category_type == "mix_fictional":
            continue
        if question_type == "yearly" or question_type == "direct_death_year" or question_type == "yearly_given_death" or question_type == "yearly_given_death_current" :
