...
def load_character_data():
    ...
    character_path = '/home/smallyan/Persona_Understanding/probe/death_probe/data/labeled_with_death_year_cleaned.json'
    
    with open(character_path, 'r') as f:
        return json.load(f)


def make_historical_figure_prompt_dataset(short_prompt, prompt, tokenizer, entity_df, use_character=False):
    ...
    # Add character information for 'when' prompt
    if use_character and short_prompt == 'when':
        try:
            ...
            print(f"Warning: Could not add characters to historical figures: {e}")
